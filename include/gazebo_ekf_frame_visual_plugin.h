#ifndef _GAZEBO_EKF_FRAME_VISUAL_PLUGIN_HH_
#define _GAZEBO_EKF_FRAME_VISUAL_PLUGIN_HH_
...
namespace gazebo
{
  ...
  class GAZEBO_VISIBLE EkfFrameVisualPlugin : public VisualPlugin
  {
    /// \brief Constructor.
    public: EkfFrameVisualPlugin();
